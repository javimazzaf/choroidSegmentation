function [P,f,W1,W2,alpha] = fastlomb(x,t,varargin)
...
%% Take the FFT's 
W1 = fft(wk1);
reft1 = real(W1(2:nf+1)); % only positive frequencies, without f=0
imft1 = imag(W1(2:nf+1));

W2 = fft(wk2);
reft2 = real(W2(2:nf+1)); 
imft2 = imag(W2(2:nf+1)); 
